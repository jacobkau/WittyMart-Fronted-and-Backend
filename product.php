...
try {
    ...
    $stmt = $pdo->prepare("
        ...
        WHERE category_id = ? AND id != ? AND (status = 'active' OR p.status IS NULL)
        LIMIT 4
    ");
            ...
            <div class="reviews-section">
                ...
                <?php else: ?>
                    <div class="no-reviews">
                        <i class="fas fa-comment" style="font-size: 40px; display: block; margin-bottom: 10px; opacity: 0.3;"></i>
